...
class DialoguesSet4 extends StatefulWidget {
  static const id = 'DialogueSet4';

  final RedHoodGame gameRef;

  const DialoguesSet4(this.gameRef, {Key? key}) : super(key: key);

  @override
  _DialoguesSet4State createState() => _DialoguesSet4State();
}

class _DialoguesSet4State extends State<DialoguesSet4> {
  String dialogue = "";
  String image = "";
  String character = "";
  int index = 0;
