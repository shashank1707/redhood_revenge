...
class DialoguesSet7 extends StatefulWidget {
  static const id = 'DialogueSet7';

  final RedHoodGame gameRef;

  const DialoguesSet7(this.gameRef, {Key? key}) : super(key: key);

  @override
  _DialoguesSet7State createState() => _DialoguesSet7State();
}

class _DialoguesSet7State extends State<DialoguesSet7> {
  String dialogue = "";
  String image = "";
  String character = "";
  int index = 0;
