...
class DialoguesSet6 extends StatefulWidget {
  static const id = 'DialogueSet6';

  final RedHoodGame gameRef;

  const DialoguesSet6(this.gameRef, {Key? key}) : super(key: key);

  @override
  _DialoguesSet6State createState() => _DialoguesSet6State();
}

class _DialoguesSet6State extends State<DialoguesSet6> {
  String dialogue = "";
  String image = "";
  String character = "";
  int index = 0;
